		...
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					...
					<img id="cpacha-image" title="点击更换" style="cursor:pointer" src="get_cpacha?v1=4&w=110&h=30&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function changeCpacha() {
		$("#cpacha-image").attr("src", 'get_cpacha?v1=4&w=110&h=30&type=loginCpacha&t=' + new Date().getTime());
	}
		...
		document.querySelector(".login-button").onclick = function(){
			    ...
			    if(password == '' || password == 'undifined'){
			    	alert("请填写密码");
			    	return;
			    }
			    if(cpacha == '' || cpacha == 'undifined'){
			    	alert("请填写验证码");
			    	return;
			    }

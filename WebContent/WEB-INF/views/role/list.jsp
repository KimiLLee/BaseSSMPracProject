...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',border:false">
		...
		<!-- End of toolbar -->
		<table id="data-treegrid" class="easyui-treegrid"
			toolbar="#wu-toolbar">
		</table>
	</div>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width: 450px; padding: 10px;">
	<form id="edit-form" method="post">
		...
		<table>
			<tr>
				<td width="60" align="right">角色名称:</td>
				<td><input type="text" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true" /></td>
			</tr>
			<tr>
                <td align="right">角色备注:</td>
...
<script type="text/javascript">
	...
	$('#data-treegrid').treegrid({
		...
		columns : [ [ 
			...
			{ field : 'name',title : '角色名称',width : 10,sortable : true}, 
			{ field : 'remark',title : '角色备注',width : 10,sortable : true}, 
			{ field : 'icon',title : '权限操作',width : 10,formatter:function(value,row,index){

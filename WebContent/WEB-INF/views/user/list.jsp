...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'center',border:false">
		...
		<!-- End of toolbar -->
		<table id="data-treegrid" class="easyui-treegrid"toolbar="#wu-toolbar"></table>
	</div>
</div>
<!-- 添加用户对话框 -->
	...
	<form id="add-form" method="post">
		<table>
			<tr>
				...
				<td valign="middle">
					<img id="preview-photo" style="float:left;margin-left:30px" width="50px" src="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" width="100px">
					<a style="float:left;margin-top:10px;margin-left:30px" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传头像</a>
				</td>
			</tr>
			<tr>
                <td width="60" align="right">头像:</td>
                <td>
                	<input type="text" id="add-photo" name="photo" value="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text" />
	...
	<form id="edit-form" method="post">
		...
		<table>
			<tr>
				<td width="60" align="right">头像预览:</td>
				<td valign="middle">
					<img id="edit-preview-photo" style="float:left;margin-left:30px" width="50px" src="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" width="100px">
					<a style="float:left;margin-top:10px;margin-left:30px" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传头像</a>
				</td>
			</tr>
			<tr>
                <td width="60" align="right">头像:</td>
                <td>
                	<input type="text" id="edit-photo" name="photo" value="/BaseProjectSSM/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text" />
...
<div id="process-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-upload',title:'上传图片'" style="width:450px; padding:10px;">
	<div id="p" class="easyui-progressbar" style="width:400px;" data-options="text:'正在上传...'"></div>
</div>
...
<script type="text/javascript">
	...
	function remove() {
		$.messager.confirm('信息提示', '确定要删除该记录？', function(result) {
			if (result) {
				var item = $('#data-treegrid').treegrid('getSelections');
	...
	$("#search-btn").click(function() {
		...
		$('#data-treegrid').treegrid('reload',option);
	});
	...
	$('#data-treegrid').treegrid({
		...
		columns : [ [ 
			...
			{ field:'photo',title:'用户头像',width:10,align:'center',formatter:function(value,row,index){
				var img = '<img src="'+value+'" width="50px" />';
				return img;
			}},
			{ field : 'username',title : '用户名',width : 10,sortable : true}, 
			{ field : 'roleId',title : '所属角色',width : 10,formatter:function(value,row,index){
